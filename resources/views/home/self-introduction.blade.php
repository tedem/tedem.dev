<section class="py-12" id="self-introduction">
    <div class="mx-auto max-w-7xl max-lg:px-4 lg:px-8">
        <div class="max-w-3xl">
            ...
            <h2 class="mt-6 font-medium tracking-tight text-slate-950 max-lg:text-2xl lg:text-3xl">
                Full-Stack Developer <span class="text-slate-600">&</span> Founder
            </h2>

            <p class="text-balance mt-6 text-lg text-slate-700">
